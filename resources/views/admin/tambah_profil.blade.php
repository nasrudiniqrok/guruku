...
@section('content')
    <div class="container-xl px-4 mt-n10">
        <h1 class="h3 mb-0 text-gray-800">Tambah Profil Guru</h1>
        @if (session('status'))
                    ...
                    <div class="col-xxl-6 col-xl-8">
                        <form action="{{ route('guru.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="jenis_guru" name="jenis_guru" class="form-control" placeholder="Masukkan Mata Pelajaran" value="">
                                @error('jenis_guru')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
