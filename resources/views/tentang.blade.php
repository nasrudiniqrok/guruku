    ...
    <div class="container">
        ...
        @forelse ($tentang as $tg)
            <div class="col-lg-4 mb-4">
                ...
                <img class="card-img-top mb-2" src="{{ Storage::url($tg->gambar) }}" alt="gambar artikel" />
                <div class="card-body bg-light text-center p-4">
                    <h4 class="">{{ $tg->judul }}</h4>
                    ...
                    <p>{{ substr($tg->deskripsi, 0, 100) }} ...</p>
                    <a href="{{ route('tentang.detail',$tg->id) }}" class="btn btn-primary px-4 mx-auto my-2"
                    >Selengkapnya</a
                    >
                </div>
                </div>
